...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.empty(self.hidden_size,n_features))
    ...
    def forward(self, w):
        ...
        h = F.relu(torch.matmul(w.float(),self.embed_to_hidden_weight.t())+self.embed_to_hidden_bias)
        h = self.dropout(h)
